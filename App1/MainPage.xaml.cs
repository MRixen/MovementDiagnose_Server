...
namespace App1
{
    public sealed partial class MainPage : Page
    {
        ...
        private int DELTA_T_TIMER_CALLBACK = 5, DELTA_T_MCP_EXECUTOR = 10, DELTA_T_ERROR_TIMER = 10;
        ...
        private Acceleration ReadAccel()
        {
            ...
            for (int i = 0; i < mcp2515.MessageSizeAdxl; i++) returnMessage[i] = globalDataSet.LOGIC_MCP2515_RECEIVER.mcp2515_read_rx_buffer0(mcp2515.REGISTER_RXB0Dx[i]);
        ...
        private void WriteAccel()
        {
            ...
            for (int i = 0; i < mcp2515.MessageSizeAdxl; i++)
            {
                ...
                if(globalDataSet.DebugMode) Debug.Write("Write sensor data: " + ReadBuf[i].ToString() + " in buffer 0 at byte " + mcp2515.REGISTER_TXB0Dx[i].ToString() + "\n");
            }
